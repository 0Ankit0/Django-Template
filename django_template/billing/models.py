...
class Product(models.Model):
    ...
    provider_product_id = models.CharField(max_length=255, null=True, blank=True, editable=False, unique=True)
...
class Price(models.Model):
    ...
    provider_price_id = models.CharField(max_length=255, null=True, blank=True, editable=False, unique=True)
    metadata = models.JSONField(default=dict, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Invoice(models.Model):
    ...
    def settled_amount(self) -> int:
        """Amount economically settled for the invoice, not the remaining balance."""

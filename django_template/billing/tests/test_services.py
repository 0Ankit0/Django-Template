...
class EntitlementIntervalTests(SimpleTestCase):
    def test_days(self):
        start = datetime(2026, 1, 1, 12, 0)
        self.assertEqual(_add_interval(start, Price.Interval.DAY, 7), datetime(2026, 1, 8, 12, 0))

    def test_weeks(self):
        start = datetime(2026, 1, 1, 12, 0)
        self.assertEqual(_add_interval(start, Price.Interval.WEEK, 2), datetime(2026, 1, 15, 12, 0))
    ...
    def test_year_preserves_calendar_month_and_clamps_day(self):

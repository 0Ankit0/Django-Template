...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveConstraint(model_name="productfeature", name="billing_product_feature_unique") if False else migrations.AlterField(model_name="subscription", name="provider", field=models.CharField(choices=[("stripe", "Stripe"), ("khalti", "Khalti"), ("esewa", "eSewa")], default="stripe", max_length=32)),
